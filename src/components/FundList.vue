            ...
            >
                    <template v-slot:item="props">
                      <tr>
                        ...
                        <td align="left">{{ props.item.fund }}</td>
                        <td nowrap="true" align="left">{{ props.item.risk_level }}</td>
                    ...
                    >
                      <v-card>
                        <v-card-title class="pb-0 pt-0 pl-0">
                          <v-col cols="9" class="text-left body-2 text-truncate">{{item.cust_number}} - {{item.fund }}</v-col>
                        ...
                        <v-list v-show="isExpanded(item)" dense>
                          <v-list-item>
                            <v-list-item-content class="align-end">{{ item.fund }}</v-list-item-content>
                          </v-list-item>
                          <v-list-item>
                            <v-list-item-content>Risk Level:</v-list-item-content>
                            <v-list-item-content class="align-end">{{ item.risk_level }}</v-list-item-content>
                          </v-list-item>
                          <v-list-item>
  ...
  export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        {text: 'Fund', sortable: false, align: 'left',},
        {text: 'Risk_Level', sortable: false, align: 'left',},
